    ...
    >
      ...
      >
        ...
        <p className="text-sm text-muted-foreground">
          Découvrez notre association étudiante et n'hésitez pas à nous écrire
      ...
      <div className="w-full max-w-4xl space-y-12">
        ...
        <section className="space-y-6">
          <motion.h2
            className="text-2xl font-bold tracking-tight text-foreground px-2"
            {...sectionMotion}
          >
            Notre Association
          </motion.h2>
              ...
              <Card className="p-2 sm:p-4 rounded-3xl border border-border/50 bg-card/90 backdrop-blur-sm shadow-sm hover:shadow-md transition-shadow">
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Bienvenue sur le site de L'ATACCothèque, votre plateforme
                    dédiée au stockage et à la consultation des annales
                    universitaires. Notre association s'engage à collecter,
                    organiser et rendre accessibles les anciens contrôles de fac
                    afin de soutenir les étudiants dans leur préparation
                    académique.
                  </p>
                </CardContent>
              </Card>
                ...
                <CardContent className="flex flex-col gap-3">
                  ...
                  <div className="bg-muted/50 rounded-lg p-2 text-center border border-border/30">
                    ...
                    <p className="text-[10px] text-muted-foreground uppercase tracking-wider mt-0.5">
                      Campus Saint Etienne du Rouvray
                    </p>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="pt-4 flex flex-col items-center text-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Salle U2.2.1
                      <br />À côté de la salle d'examen
                    </p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="p-2 sm:p-4 rounded-3xl border border-border/50 bg-card/90 backdrop-blur-sm shadow-sm hover:shadow-md transition-shadow">
                <CardContent className="pt-4 flex flex-col items-center text-center gap-3">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:association.atacc@gmail.com"

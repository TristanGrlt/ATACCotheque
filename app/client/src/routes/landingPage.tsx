    ...
    <>
      <div className="min-h-screen bg-gray-50 pb-28 font-sans text-gray-900 selection:bg-blue-200">
        ...
        <nav className="fixed bottom-4 left-4 right-4 sm:left-1/2 sm:right-auto sm:-translate-x-1/2 z-50 rounded-2xl p-2 flex justify-around sm:gap-2 items-center bg-white/90 backdrop-blur-xl border border-gray-200 shadow-2xl">
          ...
          <button
            onClick={() => navigate("/")}
            className="flex-1 sm:flex-none h-12 rounded-xl sm:w-12 sm:rounded-full flex items-center justify-center transition-all bg-blue-600 text-white shadow-md"
          >
          ...
          <button
            ...
            className="flex-1 sm:flex-none h-12 sm:w-12 rounded-xl sm:rounded-full flex items-center justify-center transition-all text-gray-400 hover:bg-gray-100 hover:text-gray-900"
          >
